...
${CMTROOT}/mgr/cmt setup -csh -pack=DatabaseSvc -version=v0 -path=/home/liujy/mongo-client/MirguestIssueReport/Prog/cpp/DatabaseProject  -no_cleanup $* >${cmtDatabaseSvctempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/mgr/cmt setup -csh -pack=DatabaseSvc -version=v0 -path=/home/liujy/mongo-client/MirguestIssueReport/Prog/cpp/DatabaseProject  -no_cleanup $* >${cmtDatabaseSvctempfile}"
